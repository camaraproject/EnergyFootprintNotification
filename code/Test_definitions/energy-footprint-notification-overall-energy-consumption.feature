Feature: CAMARA Energy Footprint Notification API v0.1.0-rc.1 - Operation calculate-energy-consumption
...
#
  ...
  Scenario: Common validations for any success scenario, just one instance id for an application is provided
    ...
    And "/components/schemas/CloudEventEnergy" in the callback should contain the parameter"$.energyConsumption" set to the expected value
